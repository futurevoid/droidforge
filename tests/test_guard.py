...
EXAMPLES: Dict[str, str] = {
    ...
    "bg-level-get": "am get-bg-restriction-level --user 0 com.whatsapp",
    "bg-level-set": "am set-bg-restriction-level --user 0 com.whatsapp exempted",
    "phantom-procs": "settings put global settings_enable_monitor_phantom_procs false",
    "am-config-get": "device_config get activity_manager max_phantom_processes",
    "am-config-put": "device_config put activity_manager max_phantom_processes 2147483647",
    "am-config-delete": "device_config delete activity_manager max_phantom_processes",
