...
| Open app info (ColorOS: Battery usage > allow background activity / auto launch; Permissions > show pop-ups while running in background) | `am start -a android.settings.APPLICATION_DETAILS_SETTINGS -d package:<p>` | - | S (AOSP); ColorOS switch names: V |
